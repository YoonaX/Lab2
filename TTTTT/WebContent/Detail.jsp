...
out.print("<tr><td align=\"center\"><font size=5 color=red> 书&nbsp本&nbsp信&nbsp息</font></td></tr>");
...
out.print("<tr><td align=\"center\"><font size=5 color=red> 作&nbsp者&nbsp信&nbsp息</font></td></tr>");
...
<br/>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
 ...
 width:124px;
 height:35px;
 color:yellow; background-repeat:no-repeat;"  onclick="location.href= 'FindByAurthor.jsp'" >
 </td>
 </tr>
